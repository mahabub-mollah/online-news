...
<div class="wrapper">
  <div id="breadcrumb">
      ...
      <li><a href="../../default.php">প্রচ্ছদ</a></li>
      <li>&#187;</li>
      <li class="current"><a href="default.php">তথ্যপ্রযুক্তি</a></li>
    </ul>
  </div>
</div>
<!-- Body -->
...
ব্যবহারকারীদের&#8230;	  </p>
	  ...
	  <p class="readmore"><div id="layer1"><br/><table width="713" height="400"><?php
		$i=0;
    ...
    echo "</tr><tr>";
		...
		?>
		  ...
		  <div align="center" class="style1" ><font size="+1" color="#007FAA"><?php echo $row1['headline'];?></font></div>
			...
			<?php ob_start(); echo $row1['shortdes'];?><a href="details.php?news=tothoprojukti&id=<?php echo $row1['id'];?>">বিস্তারিত</a>
