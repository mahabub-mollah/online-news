...
<!-- saved from url=(0086)http://www.kadirrazu.info/projects/livenews/index.php/details_news/index/4ff6dd1cd2447 -->
...
$(document).ready(function(){
  ...
  $("#newsletter_go").click( 
    ...
    function(){
        ...
        $.ajax({
        type: "POST",
        url: "../../register_sub/post_action.htm",
        dataType: "json",
...
<div id="headlines">
	  ...
	  <marquee behavior="scroll" direction="left" scrollamount="1" scrolldelay="15" truespeed="" onmouseover="this.stop()" onmouseout="this.start()">
				<li>
		<a href="500c69ac1ddee.htm">সৈয়দ আবুল হোসেনের পদত্যাগ আসন্ন!</a> &nbsp;
		</li> 
				<li>
		<a href="50038777991a3.htm">বুয়েট সংকট: উপাচার্য ও শিক্ষক সমিতিকে বাদ দিয়ে আজ বৈঠক ডেকেছেন শিক্ষামন্ত্রী</a> &nbsp;
		</li> 
				<li>
		<a href="500386f256e44.htm">রাবিতে গোলাগুলি: ঢাকার পথে গুলিবিদ্ধ সোহেল</a> &nbsp;
		</li> 
				<li>
		<a href="5003866e9edac.htm">শাহজালালে এমিরেটস ফ্লাইটে বোমাতঙ্ক</a> &nbsp;
		</li> 
				</marquee>
		</ul>
		</div>
...
<div class="wrapper">
  <div class="container">
    <div class="content">
      <h1><span style="color:maroon;">পাহাড়িদের ভূমির অধিকার রক্ষা করব</span></h1>
	  <p>
		অনলাইন ডেস্ক<br/>তারিখ: ০৫-০৭-২০১২<br/><hr/>	  </p>
	        <img class="imgr" src="../../../newsimages/cb-sheikh-hasina.jpg" alt="প্রধানমন্ত্রী শেখ হাসিনা" width="125" height="125" />
      	  <div style="font-size:12pt;">
	  প্রধানমন্ত্রী শেখ হাসিনা বলেছেন, ভূমির অধিকার ও মালিকানা যাতে পাহাড়ের 
স্থানীয় লোকেরাই পায়, তা নিশ্চিত করতে হবে। তিনি বলেন, ‘পাহাড়ে যারা ভূমির 
সত্যিকারের দাবিদার, তাদের হাতেই মালিকানা থাকবে। পাহাড়িদের ভূমির অধিকার 
সম্পূর্ণভাবে আমরা সংরক্ষণ করব।’<br>আজ শুক্রবার গণভবন থেকে রাঙামাটিতে 
পার্বত্য চট্টগ্রামের হেডম্যানদের সঙ্গে এক ভিডিও কনফারেন্সে শেখ হাসিনা 
এসব কথা বলেন। ভিডিও কনফারেন্সের মাধ্যমে রাঙামাটিতে অনুষ্ঠিত পাহাড়ের 
হেডম্যান ও কারবারিদের উন্নয়নবিষয়ক কর্মশালায় যোগ দেন শেখ হাসিনা। বেসরকারি
 একটি টিভি চ্যানেলে এ-সংক্রান্ত একটি প্রতিবেদন প্রচারিত হয়েছে।<br>প্রতিবেদনে
 শেখ হাসিনা বলেন, দুর্গম পাহাড়ি এলাকাগুলোতে সুপেয় পানির বন্দোবস্ত করতে 
সরকার চেষ্টা করে যাচ্ছে। তিনি বলেন, পাহাড়ে সোলার পাওয়ার প্লান্ট করে 
বিদ্যুত্ দেওয়ার চেষ্টা করা হচ্ছে। পাহাড়ে ছোটখাটো ব্যবসা-বাণিজ্যও গড়ে 
তোলার চেষ্টা চলছে।	  </div>
      ...
      <div id="respond">
        <form id="commentForm" action="http://www.kadirrazu.info/projects/livenews/index.php/comments" method="post">
          ...
          <p>
			...
			<input type="hidden" name="newsID" value="4ff6dd1cd2447">
          </p>
          <p>
...
<div class="wrapper colNew1">
  <div id="copyright">
    <p class="fl_left">কপিরাইট &copy; ২০১৫ - সকল স্বত্ব &reg; সংরক্ষিত - <a href="default.htm"><strong>সংবাদ ৭১</strong></a><a href="../../../default.htm"></a></p>
