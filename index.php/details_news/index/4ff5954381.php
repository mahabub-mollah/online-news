...
<div class="wrapper">
  <div class="container">
    <div class="content">
      <h1><span style="color:maroon;">মাইক্রোসফট ইমাজিন কাপে দেশি অন্নপূর্ণা</span></h1>
	  <p>
		আইসিটি ডেস্ক<br/><br/><hr/>	  </p>
	        <img class="imgr" src="../../../newsImages/imagineEditM20120704201421.jpg" alt="মাইক্রোসফট ইমাজিন কাপ" width="125" height="125" />
      	  <div style="font-size:12pt;">
	  ঢাকা: ‘মাইক্রোসফট ইমাজিন কাপ কমপিটিশন’ প্রতিযোগিতায় অংশ নিচ্ছে 
বাংলাদেশের একটি দল। এ প্রতিযোগিতায় অংশ নেওয়ার উদ্দেশ্যে বাংলাদেশ দল 
অন্নপূর্ণা নামের একটি সফটওয়্যার তৈরি করেছে।<br><br>কৃষি তথ্যভিত্তিক এ 
সফটওয়্যার তৈরির উদ্দেশ্য কৃষির উন্নতির মাধ্যমে দারিদ্র দূর করার সঙ্গে 
পরিবেশের প্রাকৃতিক ভারসাম্য রক্ষা করা সম্ভব।<br><br>এ প্রতিযোগিতায় দলটির
 জয়লাভের জন্য ভোটের প্রয়োজন। এ জন্য দলটির পক্ষ থেকে বিশ্বের সব দেশের 
বাংলাদেশি নাগরিকদের তাদের সফটওয়্যারকে ভোট দেওয়ার আহবান জানানো হয়।<br><br>আগ্রহীরা (<a href="../../../../../../supportannapurna.sytes.net/default.htm">http://supportannapurna.sytes.net</a>)
 এ সাইটে গেলেই ভোট দেওয়ার জন্য প্রয়োজনীয় নির্দেশনা পাওয়া যাবে। 
ব্রডব্যান্ড ইন্টারনেট সংযোগ থাকলে প্রতি ৩০ মিনিট পরপর ভোট দেওয়া যাবে।<br><br>তবে
 ইন্টারনেট মডেম ব্যবহার করে ভোট দিতে চাইলে প্রতিবার সংযোগ বিচ্ছিন্ন শেষে
 নতুন সংযোগ দিলেই একটি করে ভোট দেওয়া যাবে। এ ব্যাপারে আরও তথ্যের জন্য 
ওপরের লিঙ্কে ক্লিক করে ভেতরে প্রবেশ করলেই এ ব্যাপারে বিস্তারিত তথ্য 
পাওয়া যাবে।	  </div>
	...
	<!-- Container for total comment area -->
      <div id="respond">
        <form id="commentForm" action="http://www.71songbad.info/projects/livenews/index.php/comments" method="post">
          ...
          <p>
			...
			<input type="hidden" name="newsID" value="4ff5954381">
          </p>
          <p>
...
<div class="wrapper colNew1">
  <div id="copyright">
    <p class="fl_left">কপিরাইট &copy; ২০১২ - সকল স্বত্ব &reg; সংরক্ষিত - <a href="../../../default.htm">৭১ সংবাদ</a></p>
