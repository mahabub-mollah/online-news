...
<div class="wrapper">
  <div class="container">
    <div class="content">
      <h1><span style="color:maroon;">আসল পায়ের সদৃশ কৃত্রিম পা!</span></h1>
	  <p>
		অনলাইন ডেস্ক<br/>তারিখ: ০৫-০৭-২০১২<br/><hr/>	  </p>
	        <img class="imgr" src="../../../newsImages/robot-legs.jpg" alt="রোবটিক পা" width="125" height="125" />
      	  <div style="font-size:12pt;">
	  যুক্তরাষ্ট্রের গবেষকেরা মানুষের পায়ের মতোই কৃত্রিম পা বা রোবটিক পা তৈরি 
করতে সক্ষম হয়েছেন। এক খবরে বিবিসি এ তথ্য জানিয়েছে। নিউরাল ইঞ্জিনিয়ারিং 
সাময়িকীতে প্রকাশিত প্রতিবেদনে অ্যারিজোনা বিশ্ববিদ্যালয়ের গবেষকেরা 
জানিয়েছেন, কৃত্রিম পা নিয়ে তাঁদের গবেষণা মেরুদণ্ডে আঘাতপ্রাপ্ত রোগীদের 
চিকিত্সায় কাজে লাগবে।<br>মানুষের পা যেভাবে চলে এবং স্নায়ুর সাহায্যে 
নিয়ন্ত্রিত হয় কৃত্রিম পায়ের ক্ষেত্রেও একই পদ্ধতি ব্যবহার করা হয়। 
গবেষকেরা সেন্ট্রাল প্যাটার্ন জেনারেটর (সিপিজি) নামের স্নায়ুকোষের বিকল্প 
পদ্ধতি উদ্ভাবন করতে সক্ষম হয়েছেন। এ পদ্ধতিতে মাংসপেশিতে যেভাবে সংকেত 
পৌঁছায় সেভাবেই সেন্সরের সাহায্যে কৃত্রিম পায়ে সংকেত পৌঁছায় এবং 
সত্যিকারের পায়ের মতো কৃত্রিম পা ব্যবহার করেও হাঁটতে পারে মানুষ।	  </div>
      ...
      <div id="respond">
        <form id="commentForm" action="http://www.kadirrazu.info/projects/livenews/index.php/comments" method="post">
          ...
          <p>
			...
			<input type="hidden" name="newsID" value="4ff6f09254c5a">
          </p>
          <p>
