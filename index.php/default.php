...
<div id="headlines">
	  ...
	  <marquee behavior="scroll" direction="left" scrollamount="1" scrolldelay="15" truespeed="" onmouseover="this.stop()" onmouseout="this.start()">
				<li>
		<a href="index.php/details_news/index/500c69ac1ddee.php">আজ মহান বিজয় দিবস,
  ...
  <div id="topbar">
    <div id="topnav">
      <ul>
		...
		<li><a href="index.php/education/default.php">ডি আই ইউ ৩য় সমাবর্তন </a></li>
        ...
        <ul id="featurednews">
          <li><img src="images/demo/do1.jpg" alt="" />
            <div class="panel-overlay">
              <h2>আশুলিয়া,বাংলাদেশ —</h2>
              <p>  বিভীশিখাময় সেই মুহূর্তগুলো_তারজিন গার্মেন্টস ফ্যাক্টরি <br />
                <a href="#">শোকে সতব্ধ বাংলাদেশ &raquo;</a></p>
            </div>
          </li>
    ...
    <div class="column">
      ...
      <div class="holder">
        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="300" height="250" id="FLVPlayer">
          ...
          <param name="FlashVars" value="&amp;MM_ComponentVersion=1&amp;skinName=Clear_Skin_1&amp;streamName=samrat_creation&amp;autoPlay=false&amp;autoRewind=true" />
...
<div class="wrapper colNew1">
  <div id="copyright">
    <p class="fl_left">কপিরাইট &copy; ২০১৫ - সকল স্বত্ব &reg; সংরক্ষিত - <a href="#">প্রথম সকাল</a></p>
    <p class="fl_right">ডিজাইন ও উন্নয়নে -<span ><a href="#">বাইনারি টীম</a></span></p>
    <br class="clear" />
  </div>
</div>
<script type="text/javascript">
