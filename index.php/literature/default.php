...
<?php
			...
			$result1 = mysql_query("SELECT * FROM shilposahitto where  dateofpub >= '$time'  order by dateofpub desc");
  ...
  <div id="topbar">
    <div id="topnav">
      <ul>
        ...
        <li><a href="default.php">শিল্প-সাহিত্য</a></li>
...
<div class="wrapper">
  <div id="breadcrumb">
      ...
      <li><a href="../../default.php">প্রচ্ছদ</a></li>
      <li>&#187;</li>
      <li class="current"><a href="default.php">শিল্প-সাহিত্য</a></li>
    </ul>
  </div>
</div>
<!-- Body -->
...
<div class="container">
	...
	<div class="fl_left1">
	  <p><strong><a href="../details_news/index/500c6b36b0baa.php"><div id="layer1"><table width="712" height="400"><?php
		$i=0;
    ...
    echo "</tr><tr>";
		...
		?>
		  ...
		  <div align="center" class="style1" ><font size="+1" color="#007FAA"><?php echo $row1['headline'];?></font></div>
			...
			<?php ob_start(); echo $row1['shortdes'];?><a href="details.php?news=shilposahitto&id=<?php echo $row1['id'];?>">বিস্তারিত</a>
			
		  </td><?php $i++;} ?></table></div>
	  </a></strong></p>
      <p>
	  <br/><br/><div id="layer1"><table width="712" height="400"><?php
		$i=0;
		 while($row1 = mysql_fetch_array($result1))
		{
	...
	<!--<p>&nbsp;</p>
      <div id="hpage_latest1">
        <ul>
				  <li>
          <img src="../../newsImages/janani-untitled-8.jpg" width="190" height="130" alt="লুৎফন, আব্বাসউদ্দিনের স্ত্রী" />
            <p>দিন বয়ে চলেছে। সামনে কী আছে জানা নেই। স্মৃতিগুলো সব সময় খেলা করছে। কখনো 
বা তাদের নিয়ে খেলছি। এ খেলা আমার কাছে দুরন্ত খেলা। খুব&#8230;</p>
            <p class="readmore"><a href="../details_news/index/50038920416b6.php">বিস্তারিত পড়ুন  &raquo;</a></p>
          </li>
				  <li>
          <img src="../../newsImages/nariuntitled-7.jpg" width="190" height="130" alt="Female" />
            <p>ইতিহাসে দেখা যায়, বাঙালি নারীরাও কখনো কখনো উচ্চশিক্ষা লাভ করে পেশাগত 
জীবনে প্রবেশ করেছিলেন। খ্রিষ্টীয় আঠারো-উনিশ শতকের এমন তিনজন বিদুষী 
মহিলার কথা জানা যাচ্ছে। এঁদের&#8230;</p>
            <p class="readmore"><a href="../details_news/index/500388b556bc8.php">বিস্তারিত পড়ুন  &raquo;</a></p>
          </li>
        </ul>
        <br class="clear" />
      </div>-->
