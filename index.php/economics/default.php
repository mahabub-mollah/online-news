...
<?php
			...
			$result1 = mysql_query("SELECT * FROM orthoniti where  dateofpub >= '$time'  order by dateofpub desc");
  ...
  <div id="topbar">
    <div id="topnav">
      <ul>
        ...
        <li><a href="default.php">অর্থনীতি-ব্যবসা</a></li>
...
<div class="wrapper">
  <div id="breadcrumb">
      ...
      <li><a href="../../default.php">প্রচ্ছদ</a></li>
      <li>&#187;</li>
      <li class="current"><a href="default.php">অর্থনীতি-ব্যবসা</a></li>
    </ul>
  </div>
</div>
<!-- Body -->
  ...
  <div class="container">
    ...
    echo "</tr><tr>";
		...
		?>
		  ...
		  <div align="center" class="style1" ><font size="+1" color="#007FAA"><?php echo $row1['headline'];?></font></div>
			...
			<?php ob_start(); echo $row1['shortdes'];?><a href="details.php?news=orthoniti&id=<?php echo $row1['id'];?>">বিস্তারিত</a>
	...
	<!--<p>&nbsp;</p>
      <div id="hpage_latest1">
        <ul>
				  <li>
          <img src="../../newsImages/FBCCI-SM-120120703173734.jpg" width="190" height="130" alt="" />
            <p>ঢাকা: রমজানে মাসের শুরুতে নিত্য প্রয়োজনীয় পণ্যের রফতানি
 নিয়ন্ত্রণ বা বন্ধ রাখার ব্যবস্থা নেওয়ার জন্য সরকারের প্রতি আহ্বান 
জানিয়েছে ব্যবসায়ীদের শীর্ষ সংগঠন বাংলাদেশ শিল্প ও&#8230;</p>
            <p class="readmore"><a href="default.php">বিস্তারিত পড়ুন  &raquo;</a></p>
          </li>
				  <li>
          <img src="../../newsImages/ATM20120705140106.jpg" width="190" height="130" alt="এটিএম বুথ" />
            <p>ঢাকা: ব্যাংকের এটিএম বুথ স্থাপন ও ব্যবস্থাপনায় কোন 
ধরনের নীতিমালা নেই। প্রতি বছরই ব্যাংকগুলো এটিএম বুথ বাড়াচ্ছে। বাংলাদেশ 
ব্যাংক থেকে প্রাপ্ত তথ্য মোতবেক সর্বশেষ&#8230;</p>
            <p class="readmore"><a href="default.php">বিস্তারিত পড়ুন  &raquo;</a></p>
          </li>
        </ul>
        <br class="clear" />
	...
	<h4><a href="default.php">প্রথম সকাল </a> <font color="#FF0000">এর সর্বশেষ </font> সংবাদ সমুহ </h4>
      <div class="subnav"><?php include('latest.php');?> </div>
    </div>
    <br class="clear" />
</div>
</div>
...
<div class="wrapper colNew1">
  <div id="copyright">
    ...
    <p class="fl_right">ডিজাইন ও উন্নয়নে  -<span class="red"><a href="#" class="colNew1">বাইনারি টীম</a></span></p>
    <p class="fl_right">&nbsp;</p>
    <br class="clear" />
  </div>
</div>
