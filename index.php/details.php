...
<div class="wrapper"><!--Secondary Navigation Of Related News -->
    ...
    <td colspan="4" width="75%">
        ...
        <tr>
		  ...
		  <div align="center" class="style1" >
			...
			<div align="center">
			  <table align="center" width="200" border="1">
			    <tr>
			      <td><?php echo "<br>";echo $row1['reporter'];echo ",";echo $row1['place'];echo "<br>";echo "<br>"; echo $row1['longdes'];?>&nbsp;</td>
		        </tr>
		      </table>
          </div>		</td>
          </tr>
		  ...
		  <br/>
		  <br/>
		  <div align="center" style="font-size: 30px; color: #009F55;"><strong>পাঠকের মন্তব্য</strong></div>
		  <table align="center">
		  ...
		  <table>
		  <tr>
		  <div style="font-size: 22px; color: #808080;">মন্তব্য করুন</div><td>
